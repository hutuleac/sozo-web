...
const posts: Post[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: images.cortenPanouGard, alt: "Panou gard din oțel Corten perforat cu decupaje circulare — detaliu textură patinată brun-roșcat, prindere cu șuruburi", caption: "Corten perforat pentru gard — textura patinei e unică și nu poate fi replicată prin vopsire." },
      ...
      { type: "image", src: images.panouPerforatApus, alt: "Panou metalic perforat cu decupaje verticale ovale — lumina apusului filtrată prin tablă tăiată laser CNC", caption: "Lumina filtrată prin panou perforat — efect vizual care se schimbă pe parcursul zilei." },
  ...
  // ─────────────────────────────────────────────────────────────
  // 11. Oțel Corten — ce este, proprietăți, aplicații
  // ─────────────────────────────────────────────────────────────
  {
    slug: "otel-corten-ce-este-proprietati-aplicatii",
    title: "Oțel Corten: ce este, cum patinează și unde îl folosești (garduri, paturi înălțate, fațade)",
    description:
      "Ghid complet despre oțelul Corten: compoziție, proces de patinare, durabilitate 30–50 ani, aplicații exterioare (garduri, jardiniere, paturi înălțate din oțel Corten) și ce grosime alegi pentru fiecare proiect.",
    ...
    body: [
      ...
      { type: "h2", text: "Ce este oțelul Corten" },
      { type: "p", text: "Corten e o denumire comercială (inițial lansată de US Steel) pentru familia de oțeluri rezistente la intemperii standardizate în Europa ca S355J2W, S235J2W sau EN 10025-5. Aliajul adaugă la oțelul carbon cantități mici de cupru (0.25–0.55%), crom (0.4–0.65%), nichel și fosfor — proporții care schimbă radical comportamentul la coroziune." },
      { type: "callout", text: "Diferența față de oțelul obișnuit: oțelul moale corodează progresiv — rugina e poroasă, permite apei să ajungă la metal proaspăt și procesul continuă. Cortenul formează un oxid compact, aderent, care blochează accesul ulterior al oxigenului și umezelii. Odată format (6–18 luni de expunere), stratul se autostabilizează." },
      { type: "h2", text: "Cum funcționează patinarea" },
      { type: "p", text: "Procesul are trei faze:" },
      { type: "ol", items: [
        "Oxidare inițială (0–3 luni): tablă roșu-portocalie, neuniformă. Pare simplă rugină — e normal.",
        "Consolidare (3–12 luni): culoarea se adâncește spre brun-roșcat, stratul devine mai dens și aderent.",
        "Stabilizare (12–18 luni): patina ajunge la nuanța finală — brun închis, aspect catifelat. Coroziunea se oprește.",
      ]},
      { type: "p", text: "Condiție esențială: cicluri umezire–uscare. Cortenul patinează corect în aer liber, cu expunere alternantă la ploaie și soare. Într-un mediu permanent umed (subteran, imers în apă) sau în medii cu sare marină concentrată, procesul nu se stabilizează — în aceste cazuri nu e materialul potrivit." },
      { type: "h2", text: "Corten vs oțel vopsit vs inox — comparație practică" },
      { type: "table", head: ["Criteriu", "Oțel Corten", "Oțel vopsit", "Inox 304"], rows: [
        ["Durată de viață exterior", "30–50 ani", "10–15 ani (revopsire periodică)", "50+ ani"],
        ["Întreținere", "Zero după patinare", "Revopsire la 5–10 ani", "Curățare periodică"],
        ["Aspect", "Industrial, brun-roșcat unic", "Orice culoare RAL", "Metalic neutru"],
        ["Preț relativ tablă", "Mediu (similar OL)", "Mic + cost vopsire", "Ridicat (2–4×)"],
        ["Sudabilitate", "Da, cu electrozi speciali", "Da", "Da, mai pretențios"],
        ["Potrivit pentru", "Garduri, fațade, mobilier grădină", "Dulapuri, structuri interioare", "Industria alimentară, marine"],
      ]},
      { type: "image", src: images.cortenFatadaPanorama, alt: "Fațadă arhitecturală din oțel Corten perforat cu decupaje circulare — panouri patinate natural, brun-portocaliu", caption: "Corten perforat pe fațadă — după 2–3 sezoane de expunere patina se uniformizează complet." },
      { type: "h2", text: "Aplicații exterioare frecvente" },
      { type: "h3", text: "Garduri și panouri decorative" },
      { type: "p", text: "Gardul Corten e poate aplicația cea mai vizibilă în arhitectura rezidențială contemporană. Se execută din panouri tăiate laser cu pattern perforat sau din scânduri verticale. Grosimea recomandată: 3–5 mm pentru panouri, 4–6 mm pentru profil structural. La grosimi sub 3 mm patinarea poate fi neuniformă pe colțuri, la grosimi peste 8 mm aspectul vizual e același dar prețul crește disproporționat." },
      { type: "h3", text: "Fațade și acoperiri arhitecturale" },
      { type: "p", text: "Arhitecții folosesc Cortenul pe fațade de clădiri, placaje de stâlpi sau acoperiri de volume. Tablă de 2–4 mm prinsă cu sistem de ventilare e configurația tipică. Patinat pe fațadă, efectul vizual e consistent după 2–3 sezoane de ploaie." },
      { type: "image", src: images.cortenCladireArh, alt: "Clădire arhitecturală cu fațadă din oțel Corten patinat natural — panouri brune cu deschideri ventilate, design contemporan", caption: "Corten pe fațadă arhitecturală — patina naturală creează o textură unică, ireproductibilă prin vopsire." },
      { type: "h3", text: "Mobilier de grădină și jardiniere" },
      { type: "p", text: "Jardiniere, bănci, elemente de peisagistică — Cortenul rezistă fără nicio protecție suplimentară. La jardiniere dreptunghiulare simple, 3 mm e suficient. La mobilier cu rol portant, 4–6 mm. La forme complicate tăiate laser (ornamente, siluete), 2–3 mm permite toleranțe mai fine." },
      { type: "image", src: images.cortenCabinaExterior, alt: "Cabană mică cu fațadă din tablă Corten patinată — exterior brut-industrial integrat în peisaj natural verde", caption: "Corten integrat în natură — nici un finisaj adițional, nici o întreținere în 30–50 ani." },
      { type: "h2", text: "Paturi înălțate din oțel Corten" },
      { type: "p", text: "Patul înălțat de grădină din Corten e una dintre cele mai căutate aplicații domestice. Arată bine, durează decenii, nu necesită vopsire și nu putrezește ca lemnul. Dar apare o întrebare legitimă: fierul din Corten ajunge în sol și în plante?" },
      { type: "callout", text: "Răspuns scurt: nu există risc practic. Cortenul e un oțel carbon aliat — oxidul de fier care se formează la suprafață e practic insolubil în apă la pH-ul normal al solului. Cantitatea de fier care ajunge în sol e neglijabilă și sub limita de detectare în studii pe termen lung. Plantele absorb fier în formă ionică din sol — nu de pe pereții unui pat înălțat. Dacă solul e srac în fier, un pat Corten nu rezolvă deficiența; dacă solul e bun, nu există pericolul unui exces." },
      { type: "p", text: "Ce contează practic la un pat înălțat din Corten:" },
      { type: "ul", items: [
        "Grosime 2–3 mm pentru paturi mici (sub 100×60 cm), 3–4 mm pentru paturi lungi sau înalte (peste 40 cm înălțime)",
        "Colțuri sudate sau prinse cu șuruburi de interior — ambele variante funcționează",
        "Drenaj la bază — Cortenul rezistă la umiditate, dar patul trebuie să aibă ieșire pentru apă",
        "Patina inițială poate lăsa urme portocalii pe betonul sau piatra din jur în primele 3–6 luni — protejați suprafețele adiacente sau lăsați un rost de 5–10 mm",
      ]},
      { type: "h2", text: "Grosimi recomandate per aplicație" },
      { type: "table", head: ["Aplicație", "Grosime recomandată", "Observație"], rows: [
        ["Paturi înălțate mici (< 60cm lungime)", "2–2.5 mm", "Ușoare, tăiate rapid"],
        ["Paturi înălțate mari (> 100cm)", "3 mm", "Rigiditate structurală"],
        ["Panouri gard decorative", "3–4 mm", "Echilibru greutate/rezistență"],
        ["Profil structural gard", "4–6 mm", "Rezistență la impact"],
        ["Jardiniere și mobilier", "3 mm", "Standard pentru uzul exterior"],
        ["Fațade arhitecturale", "2–3 mm", "Sistem de prindere ascuns"],
        ["Sculpturi și ornamente", "2–3 mm", "Permite detalii fine laser"],
      ]},
      { type: "h2", text: "Cum comanzi Corten de la SOZO PROJECT" },
      { type: "p", text: "Procesul e identic cu orice alt material: trimiteți fișierul DXF/DWG sau schița cu dimensiunile. Specificați că materialul e Corten (S355J2W) și grosimea dorită. Dacă nu aveți fișier, descrieți forma și dimensiunile — facem noi fișierul." },
      { type: "ul", items: [
        "Formate acceptate: DXF, DWG, STEP, PDF cu cote, schiță foto",
        "Grosimi disponibile Corten: 2mm, 3mm, 4mm, 5mm, 6mm (stoc curent — verificați disponibilitatea la comandă)",
        "Termenul standard: 2–5 zile lucrătoare după confirmare",
        "Livrare: ridicare Strada Aurel Vlaicu 77, Iași sau curier în toată România",
      ]},
      { type: "internal", href: "/servicii/elemente-decorative-metal", label: "Garduri Corten, panouri, jardiniere — serviciu complet", text: "Tăiere laser Corten, orice pattern DXF, de la 1 bucată. Ofertă în aceeași zi." },
    ],
    faqs: [
      { q: "Patul înălțat din oțel Corten e sigur pentru legume și fructe?", a: "Da. Oxidul de fier format pe suprafața Corten e practic insolubil în apă la pH-ul normal al solului. Cantitatea de fier care migrează în sol e sub limita de detectare și nu prezintă risc alimentar — confirmată de studii pe termen lung. Patul Corten e sigur pentru orice cultură." },
      { q: "Cât durează patinarea completă a unui gard Corten?", a: "6–18 luni de expunere exterioară cu cicluri normale de umezire-uscare. Viteza depinde de climă: regiunile cu ploaie regulată patinează mai rapid. Culoarea finală e brun-roșcat închis, uniformă și stabilă." },
