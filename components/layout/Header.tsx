...
const navRO = [
  {
    label: "Servicii", href: "/servicii", children: [
      ...
      { label: "Elemente Decorative", href: "/servicii/elemente-decorative-metal" },
      { label: "Inox Alimentar & HoReCa", href: "/servicii/inox-industria-alimentara" },
      { label: "Balustrade & Scări Inox", href: "/servicii/balustrade-scari-inox" },
      { label: "Piese Utilaje Agricole", href: "/servicii/piese-utilaje-agricole" },
      { label: "Tablouri & Carcase Metalice", href: "/servicii/tablouri-electrice-carcase" },
    ],
  },
...
const routePairs: [string, string][] = [
  ...
  ["/servicii/elemente-decorative-metal", "/en"],
  ["/servicii/inox-industria-alimentara", "/en"],
  ["/servicii/balustrade-scari-inox", "/en"],
  ["/servicii/piese-utilaje-agricole", "/en"],
  ["/servicii/tablouri-electrice-carcase", "/en"],
  ["/contact", "/en/contact"],
