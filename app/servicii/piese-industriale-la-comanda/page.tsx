...
const faqs: FAQItem[] = [
  ...
  { q: "Faceți și finisare după tăiere — vopsire, zincare sau acoperiri anticorozive?", a: "Piesa iese din laser debavurată și gata de finisare. Pentru vopsire pulbere, zincare la cald sau tratamente anticorozive, colaborăm cu parteneri locali verificați din Iași — coordonăm lanțul complet la cerere, primiți piesa gata de montaj." },
