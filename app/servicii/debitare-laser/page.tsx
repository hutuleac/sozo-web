...
export const metadata: Metadata = {
  ...
  description:
    "Servicii debitare laser CNC în Iași. Mitsubishi ML3015EX, tablă oțel până la 20mm, inox/aluminiu până la 10mm, toleranță ±0.05mm. Ofertă în 2h. ☎ +40 732 034 386",
...
const benefits = [
  ...
  { icon: Zap, title: "Viteză", text: "Fibră laser pe tablă subțire — de câteva ori mai rapid decât CO₂. Oferta în 2 ore, urgențe în aceeași zi." },
  ...
  return (
    <>
      <ServiceHero
        ...
        intro="SOZO PROJECT oferă servicii de debitare laser CNC în Iași cu echipament Mitsubishi ML3015EX, fibră laser de 4.5kW. Tăiem oțel carbon până la 20mm, inox 304/316 și aluminiu până la 10mm, cu precizie pozițională de ±0.05mm/500mm. Trimiți fișierul DXF, DWG sau STEP și primești ofertă în 2 ore."
      ...
      <CtaSection
        ...
        subtitle="Ofertă în 2 ore. Consultanță inclusă."
      />
