...
const items: PortfolioItem[] = [
  ...
  { id: "14", src: images.portfolioSemnDirectional, alt: "Semnalistică direcțională din metal alamă — indicator LIFT cu săgeată tăiată din tablă, montaj perete interior",   title: "Semnalistică direcțională metal", material: "Oțel",   service: "Laser", industry: "Semnalistică" },
];
